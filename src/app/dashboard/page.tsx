...
export default function Dashboard() {
  ...
  return (
    <AppShell>
      <div className="relative text-white transition-colors duration-300">
        ...
        <main id="main-dashboard" className="mt-12 max-w-6xl mx-auto">
          ...
          <p className="mb-6 text-gray-300">Welcome to your creator control center. All your analytics, tools, and platform data will appear here.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <article key={card.label} className="rounded-lg p-5 border-2 bg-slate-900/85 border-cyan-400/40 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <article className="rounded-lg p-6 border-2 bg-slate-900/85 border-cyan-400/40 text-white">
              <h2 className="text-xl font-bold mb-4">Analytics Overview</h2>
              <p className="text-gray-400">Your analytics will load here. Track engagement, reach, and audience growth across all platforms.</p>
            </article>

            <article className="rounded-lg p-6 border-2 bg-slate-900/85 border-cyan-400/40 text-white">
              <h2 className="text-xl font-bold mb-4">Creator Tools</h2>
              <p className="text-gray-400">Access your content management tools, scheduling, and platform integrations here.</p>
            </article>
